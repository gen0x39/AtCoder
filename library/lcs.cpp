/*
    LCSを求めるプログラム
    競プロではLCSの文字列長を求めるだけだがこのプログラムは1組のLCSを求める
*/
...
int main(void){
    ...
    x = "ABBCCD";
    y = "ABCDEF";
    x = "sdvnvkvjnvkjvdsansadvkjnvdskjnsvkjsaskldvankndv";
    y = "djlvvnsalsdndlkndvklvdnlkvnavvvklnasvklvsavnklsav";
    int m = x.length();
    int n = y.length();
